...
//    DDRC |= (1<<GREEN_LED_SELECT)|(1<<RED_LED_SELECT);
//    DDRB |= (1<<GREEN_LED_SCROLL)|(1<<RED_LED_SCROLL);
//    DDRD |= (1<<STATUS_PIN);
//    DDRB &= ~(1<<BUTTON_SCROLL_PIN);
//    
//    while(1){
//    if(bit_is_clear(PIND,BUTTON_SCROLL_PIN)){
//   _delay_ms(8000);
//   while(bit_is_clear(PIND,BUTTON_SCROLL_PIN)){
//       press_confidence_level++;
//       if(press_confidence_level>level){
//           count++;
//           press_confidence_level=0;
//           if(count>80){
//       
//       
//  
...
//        // Released
//        if ((now - btn1_press_time < LONG_PRESS_MS) && !btn2_pressed && systemState == ON) {
//            colorState = (colorState + 1) % 3;
//            update_rgb_led();
//        }
//        btn1_pressed = 0;
//    }
//         if (btn1_pressed && btn2_pressed && (now - btn1_press_time >= LONG_PRESS_MS) && (now - btn2_press_time >= LONG_PRESS_MS)) {
//        blinking = 1;
//        blink_times = 0;
//        last_blink_time = now;
//        btn1_pressed = btn2_pressed = 0;
//        systemState = OFF;
//        update_status_led();
//        update_rgb_led();
...
//            PORTB ^= (1 << RGB_RED) | (1 << RGB_GREEN) | (1 << RGB_ORANGE); // toggle
//            last_blink_time = now;
//            blink_times++;
//
//            if (blink_times >= BLINK_COUNT * 2) { // ON + OFF per blink
//                blinking = 0;
//                PORTB &= ~((1 << RGB_RED) | (1 << RGB_GREEN) | (1 << RGB_ORANGE));
//            }
//        }
//    }
//}
...
//    
//    }
//}single switch long press
//    if (button_sel_press && !button_srl_press &&
//        (prst_time - button_sel_time >= long_press_time)) {
//        switch (STATE) {
//            case GREEN: green_scroll_on = green_scroll_backup; break;
//                 case RED: red_scroll_on = red_scroll_backup; break;
// case ORANGE: orange_scroll_on = orange_scroll_backup; break;
//        }
//        button_sel_press = 0;
//        led_srl_update();
//        update_outputs();
